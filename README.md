...
**That's it!** You now have access to 38 agents, 157 skills, and 72 legacy command shims.
...
|   |-- agent-memory/               # Persistent cross-session memory via MCP knowledge graph (NEW)
|
...
| Skills | PASS: 157 skills | PASS: 37 skills | **Claude Code leads** |
...
| **Skills** | 157 | Shared | 10 (native format) | 37 |
