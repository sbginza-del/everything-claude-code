...
- 2026-05-02: Added `agent-memory` skill for persistent cross-session knowledge graph memory via MCP memory tools. Registered under the `agentic-patterns` install module.
